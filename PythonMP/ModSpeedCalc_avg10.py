...
def flow2speed_2p_old(inSpace, currentIter, FL, LIMIT):
    '''
    This function takes detector flow and convert to detector level speed.
    
    Outputs to outCSV = inSpace+'detspd'+str(currentIter)+'-P.csv'
    
    Each iteration's resulting speed is weighted Demand+supply.
    '''
    import sys
    import numpy as np
    from math import exp
    ...
    try:
        ...
        numBack = 10    # How many iteration back to include in the exp. +1 = total number for exp
