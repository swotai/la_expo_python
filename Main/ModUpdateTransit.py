...
VOT = 21.46.  VOT is updated/calculated afterwards in Stata
"""
...
def joinSpeed(inSpace, inGdb, inSpeed):
    ...
    try:
        ...
        arcpy.CalculateField_management (inBlue, "Cost", "!DPS!*21.46", "PYTHON")
        arcpy.CalculateField_management (inExpo, "Cost", "!DPS!*21.46", "PYTHON")
        arcpy.CalculateField_management (inGold, "Cost", "!DPS!*21.46", "PYTHON")
        arcpy.CalculateField_management (inGreen, "Cost", "!DPS!*21.46", "PYTHON")
        arcpy.CalculateField_management (inRed, "Cost", "!DPS!*21.46", "PYTHON")
