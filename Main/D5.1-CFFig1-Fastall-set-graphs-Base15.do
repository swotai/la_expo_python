...
use "C:/Users/Dennis/Desktop/Results/1028/CF-fastall-set-base15.dta", clear
cd "D:\Dropbox\Cornell\LA Expo Line Project\Data Files\Gravity Flow Prediction\Output\Base15"
...
subtitle(Compared to Metro at 15mph) 
ytitle(Hours) 
xtitle(Metro speed mph) 
ylabel(, labsize(vsmall)) 
note("Note: "
...
title(Total welfare effect of various Metro speeds) subtitle(Compared to Metro at 15mph)  
note("Note:"
...
over(speed) stack ytitle(Dollar amount) ylabel(, labsize(vsmall) format(%16.0gc) angle(forty_five)) 
title(Total welfare effect of various Metro speeds-adjusted) subtitle(Compared to Metro at 15mph)  
note("Note:"
"Pollution reduction calculated by multiplying the driving vehicle miles removed with"
"the various emission parameters following Table 8, at each counterfactual speeds."
"Congestion relief calculated by calculating the reduction in delay per mile in highway"
