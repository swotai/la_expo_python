...
nx.write_graphml(newG, inSpace+'LANetworkClean_graphml.txt')

# Save TAZlist raw base on nodes to file TAZlist_json
import json
#print 'Saving TAZ into JSon'
#f=open(inSpace+'TAZlist_json.txt', 'wb')
#f.write(json.dumps(tazlist, sort_keys = True))
#f.close()
