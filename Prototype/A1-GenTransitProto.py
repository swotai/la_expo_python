...
#   e.g. predps, postdps  Should be 'post' unless it's 'pre'.
    ...
    inNetwork = "TransitBase/Transit_ND"
##################################
...
### Cost matrix calculation
    ...
    for inSpeed in range(initspd, topspd+1):
        ...
        # 2, Update transit speed
        ModUpdateTransit.joinSpeed(inSpace,inGdb,inSpeed, vot)
        ...
        outname = "CSV/TT" + str(inSpeed) + ".csv"
        ModSolve.solvetransTT(inSpace, inNetwork, inGdb, fcTAZ, outname)
