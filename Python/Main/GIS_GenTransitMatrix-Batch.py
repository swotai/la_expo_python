...
### Generate Transit OD cost matrices
...
#### Post Counterfactual equilibrium calculation
    print "Post transit calculation starts on", time.strftime("%d/%m/%Y - %H:%M:%S")
    inSpace = "C:/Users/Dennis/Desktop/TransitPost_Fast/"    #Counterfactual: Expo is faster to 34mph (2x speed ~ green line)
...
#    del inSpace    
#    # Paths
#    fTT = 'C:/Users/Dennis/Desktop/Pre/CSV/'+'TT.csv'
#    fTotalTTflow = 'C:/Users/Dennis/Desktop/Pre/CSV/'+'TotalTTflow1.csv'
#    fTransitPre = 'C:/Users/Dennis/Desktop/TransitPre/CSV/'+'TT.csv'
#    fTransitPost= 'C:/Users/Dennis/Desktop/TransitPost/CSV/'+'TT.csv'
#    fTransitPostCF= 'C:/Users/Dennis/Desktop/TransitPost_Fast/CSV/' + 'TT.csv'
#    
...
#
#    # Read TransitPost CF TT cost matrix
#    TransitPostcf = pd.read_csv(fTransitPostCF, header=None)
#    TransitPostcf.columns = [TransTTlabel]   # Rename columns
#    odNames = pd.DataFrame(TransitPostcf['v3'].str.split(' - ').tolist(), columns=['oid','did'])   # substring the v3 into oid and did strs
#    odNames = odNames.convert_objects(convert_numeric=True)   # destring, replace
#    TransitPostcf['oid'] = odNames['oid']
#    TransitPostcf['did'] = odNames['did']
#    TransitPostcf['fare'] = 1.25*(TransitPostcf['busl']+TransitPostcf['metrol']>0)    # Generate fare
#    TransitPostcf['cost'] = TransitPostcf['dps']*vot + TransitPostcf['fare']          # Update cost
#    TransitPostcf = TransitPostcf[['oid','did','dps','fare','cost','busl','metrol','walkl','length']]   # keep relavent variables
#    colname = TransitPostcf.columns.values   
#    colname = ['postcf'+name for name in colname]   # Rename variables
#    colname[0:2] = ['oid','did']
#    TransitPostcf.columns = colname
#        
#    # The Big Merge
...
#    Dataset=pd.merge(Dataset, TransitPostcf,left_on=['oid', 'did'], right_on=['oid', 'did'], how='inner')
#    
#    # Generate new Sij
...
#    Dataset['costdiffpostcf'] = 5.45-5.05*(Dataset['postcfcost']/Dataset['predrvcost'])
#    
...
#    Dataset['Sijpostcf'] = np.exp(Dataset['costdiffpostcf'])/(1 + np.exp(Dataset['costdiffpostcf']))
#    
...
#    Dataset['dflowpostcf'] = Dataset['totalflow'] * (1-Dataset['Sijpostcf'])
#    Dataset['tflowpostcf'] = Dataset['totalflow'] * (Dataset['Sijpostcf'])
#    
#    tflowpre = Dataset[['oid','did','tflowpre']]
#    tflowpost= Dataset[['oid','did','tflowpost']]
#    tflowpostcf= Dataset[['oid','did','tflowpostcf']]
#
#    fTransitPre = 'C:/Users/Dennis/Desktop/TransitPre/CSV/'+'TT.csv'
#    fTransitPost= 'C:/Users/Dennis/Desktop/TransitPost/CSV/'+'TT.csv'
#    fTransitPostCF= 'C:/Users/Dennis/Desktop/TransitPost_Fast/CSV/'+'TT.csv'
#    
#    tflowpre.to_csv('C:/Users/Dennis/Desktop/TransitPre/CSV/'+'TransTTflow1.csv', header=None, index = None)
#    tflowpost.to_csv('C:/Users/Dennis/Desktop/TransitPost/CSV/'+'TransTTflow1.csv', header=None, index = None)
#    tflowpostcf.to_csv('C:/Users/Dennis/Desktop/TransitPost_Fast/CSV/'+'TransTTflow1.csv', header=None, index = None)
#    
#    # Write it out to see if it works
#    Dataset.to_stata('C:/Users/Dennis/Desktop/Test/'+'test.dta')
#    # Test.dta checks out fine...
...
#    flow = alloc_trans(inSpace, inFlow, currentIter)
#    
#    print "Post CF transit calculation completes on", time.strftime("%d/%m/%Y - %H:%M:%S")