...
if __name__ == '__main__':
    import ModSetupWorker, ModBuild, ModUpdateExpo
    import time
    currentIter = 1
...
#       2) path to transit network dataset
    drvpath = 'D:/SWOT/Desktop/Pre/'
    transitpath = 'D:/SWOT/Desktop/CalcTransit/CF-fastexpo/'
    inSpace = transitpath
...
##################################
    ...
    while currentIter < (maxspeed + 1): 
        ...
        # 1, Update speed
        ModUpdateExpo.joinSpeed(inSpace, inGdb, speed)
        ...
        ### TODO: TT.csv Seems not updated for second round calculation???
        # But that would lead to transit cost matrix not udpate. but it DOES update.... what gives?
        ...
        TransitPre = pd.read_csv(fTransitTT, header=None)
